%% ECCV 2020 Image Inpainting on TCSC
% David Reixach - IRI(CSIC-UPC) - 20.02.2020
...
save2([dataPath,name,'TrainResults.mat'],'resTrain')
save2([dataPath,name,'TestResults.mat'],'resTest')
